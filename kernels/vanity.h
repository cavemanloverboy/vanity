...
extern "C" void vanity_round(int gpus, uint8_t *seed, uint8_t *base, uint8_t *owner, char *prefix, uint64_t prefix_len, char *suffix, uint64_t suffix_len, uint8_t *out, bool case_insensitive, bool leet_speak);
